  ...
  return (
    <section className="proof-index" id="work" aria-labelledby="proof-index-title" data-header-tone="light">
      <div className="proof-index-intro" data-reveal>
        <p className="section-kicker section-kicker--dark">Selected work &amp; systems</p>
        <h2 id="proof-index-title">Evidence<br /><em>before theatre.</em></h2>
        <p className="section-lede">
          Live storefronts, operating archives and in-house systems. Every entry states what was verified—and what it
          does not attempt to prove.
        </p>
      </div>

      <div className="proof-index-list" aria-label="Verified work and systems">
          ...
          return (
            ...
            >
              ...
              <span className="proof-index-copy">
                ...
                <span id={descriptionId}>{entry.summary}</span>
                <span className="proof-index-verification">
                  <span className="proof-status" data-status={entry.status}>{entry.status}</span>
                  {capture ? <span className="proof-capture-date">{capture}</span> : null}
                </span>
              </span>
