...
- Mandatory form acknowledgement is a notice acknowledgement, not consent to contact; optional email marketing remains separate and records wording version, source and timestamp.
...
- Marketing selection is recorded as unverified intent and cannot activate a subscription until separate email confirmation. The public response exposes only `qualified` or `review`.
...
1. Obtain an official company-register extract and add the registered office and REA number. Confirm a corporate privacy email/PEC; do not rely on a personal PEC unless formally approved.
...
6. Implement the internal retention job/review: unconverted leads up to 24 months from last meaningful interaction (low-fit review at 12 months), active opportunities through activity plus 24 months, marketing until withdrawal or 24 months inactivity, and fiscal documents—not the full CRM ledger—where a ten-year statutory period applies.
...
- Optional email marketing: separate consent under Article 6(1)(a) and applicable Italian electronic-communications rules.
